...
<div class="container-fluid">
	...
	<ul class="nav nav-tabs mb-3" id="tabDadosCliente" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="clientes-tab" data-toggle="tab" href="#clientes" role="tab" aria-controls="clientes" aria-selected="false">Relatório de Clientes</a>
        </li>

        <li class="nav-item">
            <a class="nav-link" id="materias-tab" data-toggle="tab" href="#materias" role="tab" aria-controls="materias" aria-selected="false">Relatório de Matérias</a>
        </li> 
    ...
    <div class="tab-content" id="tabDadosContratoConteudo">
    	<div class="tab-pane fade show active" id="contratos" role="tabpanel" aria-labelledby="contratos-tab">					
			<form method="POST" action="contratos.php" target="_blank"> 
				<div class="form-row">
        ...
        <div class="tab-pane fade" id="materias" role="tabpanel" aria-labelledby="materias-tab">
        	<form method="POST" action="materias.php" target="_blank">
				<div class="form-row">
					<div class="form-group col-md-6">
