...
<html>
    <head>
        ...
        <title>DataWork &middot; Erro 404</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="text-center mt-4">
                                    <img class="mb-4 img-error" src="<?php echo BASEURL; ?>/images/brand/error-404-monochrome.svg" />
                                    <p class="lead">A URL requisitada não existe neste servidor.</p>
