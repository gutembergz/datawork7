...
class PHPJasper
{
    ...
    public function __construct()
    {
        ...
        // alterações feitas para compatibilidade do servidor KingHost
        $this->executable = 'java -jar ' .  __DIR__  . '/../bin/jasperstarter/lib/jasperstarter.jar';
        $this->pathExecutable = __DIR__ . '/../bin/jasperstarter/lib/';        
